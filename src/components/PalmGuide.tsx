  ...
  const primaryLines = [
    {
      key: "heart" as const,
      title: "Линия сердца",
      text: "Верхняя дуга под пальцами. Идёт от стороны мизинца к указательному или среднему пальцу. Показывает эмоции, близость, любовь и личные стандарты в отношениях.",
    },
    {
      key: "head" as const,
      title: "Линия головы",
      text: "Средняя диагональная линия. Обычно стартует рядом с линией жизни у перепонки большого и указательного пальцев, затем идёт через центр ладони к внешнему ребру. Показывает стиль мышления, рациональность и интуицию.",
    },
    {
      key: "life" as const,
      title: "Линия жизни",
      text: "Большая дуга вокруг холма большого пальца. Стартует у перепонки между большим и указательным пальцами, затем уходит внутрь ладони и опускается к запястью. Описывает запас энергии, устойчивость и отношение к переменам.",
    },
    {
      key: "fate" as const,
      title: "Линия судьбы",
      text: "Вертикальная линия от запястья к центру ладони и среднему пальцу. Показывает призвание, карьерный путь и степень самостоятельного выбора.",
    },
  ];
        ...
        <div className="p-5 space-y-5">
          ...
          <div className="bg-zinc-50 border border-zinc-100 rounded-2xl p-4">
            ...
            <p className="text-[10px] text-zinc-500 leading-relaxed mt-3 text-center">
              Анализ выполняется ладонью вверх. Правая рука: большой палец справа, мизинец слева. Левая рука: большой палец слева, мизинец справа.
            </p>
          </div>
