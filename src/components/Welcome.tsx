  ...
  return (
    <section className="welcome-hero relative isolate flex min-h-[calc(100svh-65px)] items-start overflow-hidden bg-[#160f18] text-white">
      <picture className="absolute inset-0 -z-20 block h-full w-full">
        <source media="(max-width: 640px)" srcSet="/owl-palmistry-hero-tall.jpg" />
        <img
          src="/owl-palmistry-hero-wide.jpg"
          alt="Мистическая сова держит свиток с ладонью и золотыми линиями хиромантии"
        ...
        <div className="max-w-lg">
          ...
          <form onSubmit={handleSubmit} className="mt-8 max-w-md">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              />
              <button type="submit" className="owl-button flex items-center justify-center gap-2 rounded-xl bg-white px-5 py-3.5 text-xs font-semibold uppercase tracking-[0.16em] text-zinc-900 transition hover:bg-zinc-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white">
